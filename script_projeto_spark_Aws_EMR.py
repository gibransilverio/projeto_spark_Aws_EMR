...
df.write.format("parquet")\
        .mode("overwrite")\
        .save("s3a://processing-zone-gs/df-parquet-file.parquet")

# lendo arquivos parquet
df_parquet = spark.read.format("parquet")\
 .load("s3a://processing-zone-gs/df-parquet-file.parquet")
...
df_result.write.format("parquet")\
         .mode("overwrite")\
         .save("s3a://curated-zone-gs/df-result-file.parquet")



df_final_resut = spark.read.format('parquet')\
                 .load('s3a://curated-zone-gs/df-result-file.parquet')
